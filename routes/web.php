...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/controle-estoque/ajuste',  [ControleEstoqueController::class, 'ajuste'])->name('controle.estoque.ajuste');
    ...
    Route::get('/caixa/diaria', [CaixaController::class, 'diaria'])->name('caixa.diaria');
